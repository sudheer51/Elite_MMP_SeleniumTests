...
public class EditProfilePage extends TestBase {
	...
	public boolean validateAfterLogout(String uname , String pword, String url) {
	...
	public void editAllFields() throws Exception{
	...
	public void editFirstName() {
		...
		char add = (char)(65+rand.nextInt(26));
		String firstNameValue = "QAEditFirstName"+add;
		we.clear();
	...
	public void editWeight(){
		...
		helperObj.highLightElement(we);
		String weightValue = 20+rand.nextInt(200)+"";//metric  
		we.clear();
	...
	public void editHeight(){
		...
		helperObj.highLightElement(we);
		String heightValue = 30+rand.nextInt(200)+"";//metric 
		we.clear();
		...
		for (WebElement webElement : errElements) {
			...
			if(webElement.isDisplayed()){
				...
				if((webElement.getText().contains("appear"))||(webElement.getText().contains("SSN"))){
					String value = AppLibrary.getRandomNoOfDigits(9)+"";
					driver.findElement(By.xpath(xpath)).clear();
