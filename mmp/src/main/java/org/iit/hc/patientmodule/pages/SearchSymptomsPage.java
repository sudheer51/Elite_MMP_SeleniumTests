...
public class SearchSymptomsPage {
	 ...
	 * To validate, returning boolean result - As the application is not throwing any error for 
	 * invalid symptoms entry, and as it's not displaying irrelevant diagnosis for invalid symptoms, 
	 * it's a bug. To avoid this will send the result as true.
	 */
public boolean validateSymptoms(String DP_Symptoms) throws InterruptedException {
